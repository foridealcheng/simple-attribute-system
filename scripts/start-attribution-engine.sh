...
CONFIG_FILE="$PROJECT_DIR/config/attribution-engine.yaml"

echo "========================================="
echo "Starting Attribution Engine Job"
echo "========================================="
...
# 提交 Flink Job
echo "Submitting Attribution Engine Job to Flink..."
flink run \
...
echo ""
echo "========================================="
echo "Attribution Engine Job submitted successfully!"
echo "========================================="
echo ""
